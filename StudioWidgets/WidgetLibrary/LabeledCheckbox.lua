...
function LabeledCheckboxClass.new(nameSuffix, labelText, initValue, initDisabled, XOffset)
	local self = {}
	...
	button.Position = UDim2.new(0, GuiUtilities.StandardLineElementLeftMargin + (XOffset or 0), .5, 0)
