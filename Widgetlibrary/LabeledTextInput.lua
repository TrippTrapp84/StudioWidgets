...
function LabeledTextInputClass.new(nameSuffix, labelText, defaultValue,TextBoxWidth)
	local self = {}
	...
	textBoxWrapperFrame.Size = UDim2.new(0, TextBoxWidth or kTextInputWidth, 0.6, 0)
